        ...
        <div className="contact">
            <div className="container">
                <div className="row align-items-left my-5">
                    ...
                    <h4 className="font-weight-light" class = "text-justify">About Me</h4>
                    <p align="left" class = "text-justify">
                ...
                {/* <div className="row align-items-center my-5">
                    <h3 className="font-weight-light" class = "text-justify">About Me</h3>
                    <p align="left" class = "text-justify">
                        I am a Master student in the <a href="https://masterschool.eitdigital.eu/">EIT Digital Master School</a> 
                        and my second year is at <a href="https://www.eurecom.fr/en">EURECOM</a>. This is the project for the Course 
                        in Cloud Computing and Distributed Systems. My primary interests lie in 
                    </p>
